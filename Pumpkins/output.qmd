...
figure_1 = sns.scatterplot( #Creates scatter plot
    data = pumpkins, #Selects pumpkins
    x = 'est_weight_kg', #x axis
    y = 'weight_in_kg', #y axis
    hue = 'weight_class', #colours by weight class
    palette='colorblind') #colourblind friendly
figure_1.figure.set_size_inches(7.8,5)
figure_1.figure.tight_layout(rect=[0, 0.03, 0.80, 0.95])
...
```{python}
#| echo: true
figure_1.figure.savefig("pumpkins_weight_relationship.png", dpi = 300) #Saves the first figure to disk. Increased DPI to improve readability.
```
